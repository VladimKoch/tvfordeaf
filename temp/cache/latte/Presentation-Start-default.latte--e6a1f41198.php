...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/Start/default.latte */
final class Template_e6a1f41198 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/Start/default.latte';
...
-moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:blue;font-size:1.5rem" class="text-center">Start!</h1>
        <p class="text-center"style="font-size:0.875rem">Tady můžete najít jak se naučit znakovou řeč.</p></div>
