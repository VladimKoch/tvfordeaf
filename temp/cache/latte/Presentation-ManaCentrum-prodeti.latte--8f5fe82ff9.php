...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/prodeti.latte */
final class Template_8f5fe82ff9 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/prodeti.latte';
      ...
      <a href="';
		...
		echo '"style="text-decoration:none; color:blue">ManaCentrum</a>
         <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
              ...
              -moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:blue;font-size:1.5rem" class="text-center">Příběhy pro děti</h1>
              <p class="text-center"style="font-size:0.875rem">Dětské příběhy o Bohu</p>
          </div>
              <!-- Post -->
