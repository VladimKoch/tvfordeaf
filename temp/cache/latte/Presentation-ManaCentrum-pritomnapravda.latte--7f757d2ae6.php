...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/pritomnapravda.latte */
final class Template_7f757d2ae6 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/pritomnapravda.latte';
...
';
		foreach ($videos as $video) /* line 17 */ {
			...
			echo LR\Filters::escapeHtmlAttr($video->video_url) /* line 22 */;
			echo '"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" allowfullscreen></iframe>
                            ...
                            <p class="text-center">';
			echo LR\Filters::escapeHtmlText($video->title) /* line 24 */;
			echo '</p>
                      </div>
                  </div>
              </div>    
