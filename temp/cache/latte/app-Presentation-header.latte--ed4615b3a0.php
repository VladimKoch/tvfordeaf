...
final class Template_ed4615b3a0 extends Latte\Runtime\Template
{
	...
	public function main(array $ʟ_args): void
	{
		...
		echo '<nav class="navbar navbar-expand-lg header" style="height: 65px; width: 70%; margin:auto; border-radius:0 0 10px 10px; background: white;">
    <div class="container-fluid">
		...
		echo '/uploads/img/znak.jpg" alt="Symbol for Deaf" class="ucho" style="height: 40px; width: 40px;">
        </a>
		...
		echo '"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Home:onas')) /* line 15 */;
		...
		echo '/uploads/img/Fulllogo-origin.png" class="logo-tv" style="height:40px; width:40px; transform: scale(1.2);">
                </li>
            </ul>
        </div>
    </div>
