...
/** source: C:\xampp\htdocs\tvfordeaf\app\Presentation\ManaCentrum/studium.latte */
final class Template_078b8bc053 extends Latte\Runtime\Template
{
	public const Source = 'C:\\xampp\\htdocs\\tvfordeaf\\app\\Presentation\\ManaCentrum/studium.latte';
    ...
    <a href="';
        ...
        <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
              ...
              <p class="text-center"style="font-size:0.875rem">Interaktivní studium Bible</p>
          </div>
            <!-- Post -->
