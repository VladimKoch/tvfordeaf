...
final class Template_56490837fc extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['video' => '17'], $this->params) as $ʟ_v => $ʟ_l) {
	...
	public function blockContent(array $ʟ_args): void
	{
		...
		echo '
      <div class="container px-4 py-5 pb-5" style="margin-top: 50px; margin-bottom: 100px;">
      <a href="';
		...
		echo '"style="text-decoration:none; color:blue">ManaCentrum</a>
         <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
              ...
              -moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:blue;font-size:1.5rem" class="text-center">Přítomná pravda</h1>
              <p class="text-center"style="font-size:0.875rem">Trojandělské poselství</p>
          </div>
              <!-- Post -->
              <div class="row g-4 py-5 row-cols-2 row-cols-lg-4"> 
            
';
		foreach ($videos as $video) /* line 17 */ {
			echo '                  <div>             
                    <div class="col-12">               
			...
			echo LR\Filters::escapeHtmlAttr($video->video_url) /* line 23 */;
			echo '" target="_blank">
                              <img src="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 24 */;
			echo '/uploads/pravda/';
			echo LR\Filters::escapeHtmlAttr($video->jpg) /* line 24 */;
			echo '" alt="';
			echo LR\Filters::escapeHtmlAttr($video->title) /* line 24 */;
			echo '" style="min-width:100%; height:200px; object-fit:cover;">
                              </a>

                            </div>
                            <p class="text-center">';
			echo LR\Filters::escapeHtmlText($video->title) /* line 29 */;
			echo '</p>
                      </div>
                  </div>
              </div>    
';
      ...
      <nav aria-label="Jednoduchá stránkování" class="d-flex justify-content-center">
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('this', ['page' => $page - 1])) /* line 38 */;
		echo '">Předchozí</a>
              </li>
...
';
		...
		$i++) /* line 41 */ {
			...
			echo '">
                  <a class="page-link" href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('this', ['page' => $i])) /* line 43 */;
			echo '">';
