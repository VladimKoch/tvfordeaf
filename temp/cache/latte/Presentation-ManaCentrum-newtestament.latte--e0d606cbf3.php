...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/newtestament.latte */
final class Template_e0d606cbf3 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/newtestament.latte';
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['new' => '19'], $this->params) as $ʟ_v => $ʟ_l) {
    ...
    <a href="';
        ...
        <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
              ...
              <p class="text-center"style="font-size:0.875rem">Nový Zákon</p>
          </div>
            <!-- Post -->
            <div class="row g-4 py-5 row-cols-sm-1 row-cols-md-2 row-cols-lg-3"> 
          
';
		foreach ($news as $new) /* line 19 */ {
			echo '		          <div>
			...
			echo LR\Filters::escapeHtmlAttr($new->video_url) /* line 26 */;
			echo '" target="_blank">
                            <img src="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($new->jpg_url)) /* line 27 */;
			echo '" alt="';
			echo LR\Filters::escapeHtmlAttr($new->title) /* line 27 */;
...
';
		...
		$i++) /* line 50 */ {
			...
			echo '">
        <a class="page-link" href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('this', ['page' => $i])) /* line 52 */;
			echo '">';
...
';
		...
		echo '
    <li class="page-item ';
		if ($page >= $pageCount) /* line 56 */ {
			echo 'disabled';
		}
		echo '">
      <a class="page-link" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('this', ['page' => $page + 1])) /* line 57 */;
		echo '">Další</a>
    </li>
