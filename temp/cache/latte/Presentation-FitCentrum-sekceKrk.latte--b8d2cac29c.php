...
/** source: C:\xampp\htdocs\tvfordeaf\app\Presentation\FitCentrum/sekceKrk.latte */
final class Template_b8d2cac29c extends Latte\Runtime\Template
{
	public const Source = 'C:\\xampp\\htdocs\\tvfordeaf\\app\\Presentation\\FitCentrum/sekceKrk.latte';
...
<div class="container py-5">
    <div class="col-xl-10 mx-auto">
		...
		echo '" class="text-decoration-none fw-bold "style="color:green;">FitCentrum</a> 
            <i class="fa-solid fa-chevron-right text-muted mx-2" style="font-size: 0.8rem;"></i>
              <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('FitCentrum:sekcerostlin')) /* line 16 */;
		echo '" class="text-decoration-none fw-bold "style="color:green;">Encyklopedie rostlin</a> 
            <i class="fa-solid fa-chevron-right text-muted mx-2" style="font-size: 0.8rem;"></i> 
            <span class="text-muted fw-semibold">Krk, nos, ústa</span>
        </div>
      ...
      <div class="border border-black-900 rounded overflow-hidden shadow-sm" style="height:70px;margin-bottom:20px; background: white;">
        <h1 style="color:green;font-size:1.5rem" class="text-center">Krk, nos, ústa</h1>
            <p class="text-center" style="font-size:0.875rem">jak léčit problémy s krkem, nosen a ústami</p></div>
            <!-- Post -->
...
';
		foreach ($posts as $post) /* line 27 */ {
                    ...
                    <div class="card-group">
                        <div class="card card__container border-0">
                           <article class="card__article">
                                    ...
                                    <a href="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($post->web_url)) /* line 34 */;
			...
			echo '/uploads/img/';
			echo LR\Filters::escapeHtmlAttr($post->photo_url) /* line 39 */;
			...
			echo LR\Filters::escapeHtmlText($post->content) /* line 42 */;
			echo '</span>
                                        <h5 class="card__title card-title text-center" style="color:white">';
			echo LR\Filters::escapeHtmlText($post->title) /* line 43 */;
			echo '</h5>
                                    </div>
