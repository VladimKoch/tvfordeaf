...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/Tip/default.latte */
final class Template_6c51f4c008 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/Tip/default.latte';
...
-moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:blue;font-size:1.5rem" class="text-center">Tip</h1>
        <p class="text-center"style="font-size:0.875rem">Tady můžete najít různé typi pro umění lidí, výlety, peřličky ze světa.</p></div>
            <!-- Post -->
