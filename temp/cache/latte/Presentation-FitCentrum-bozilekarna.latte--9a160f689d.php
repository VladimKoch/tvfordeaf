...
final class Template_9a160f689d extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['bilinka' => '15'], $this->params) as $ʟ_v => $ʟ_l) {
    ...
    <a href="';
     ...
     <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
        ...
        -moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:green; font-size:1.5rem" class="text-center">Boží lékárna</h1>
        <p class="text-center" style="font-size:0.875rem">Zde najdete Bilinky</p></div>
            <!-- Post -->
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-5"> 
';
		foreach ($bilinky as $bilinka) /* line 15 */ {
			echo '		          <div>   
                <div class="col-12">
                    <div class="card-group">
                        <div class="card card-fit card__container border-0">
                            <article class="card__article">
                                    ...
                                    <a href="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($bilinka->web_url)) /* line 22 */;
			...
			echo '/uploads/img/';
			echo LR\Filters::escapeHtmlAttr($bilinka->photo_url) /* line 27 */;
			...
			echo LR\Filters::escapeHtmlText($bilinka->content) /* line 30 */;
			echo '</span>
                                        <h5 class="card__title card-title text-center" style="color:white">';
			echo LR\Filters::escapeHtmlText($bilinka->title) /* line 31 */;
			echo '</h5>
                                    </div>
