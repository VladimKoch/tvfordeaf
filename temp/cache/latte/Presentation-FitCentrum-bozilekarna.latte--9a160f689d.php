...
final class Template_9a160f689d extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['bylinka' => '15'], $this->params) as $ʟ_v => $ʟ_l) {
...
';
		foreach ($bylinky as $bylinka) /* line 15 */ {
			echo '		          <div>   
                <div class="col-12">
                    <div class="card-group">
                        <div class="card card-fit card__container border-0">
                            <article class="card__article">
                                    ...
                                    <a href="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($bylinka->web_url)) /* line 22 */;
			...
			echo '/uploads/img/';
			echo LR\Filters::escapeHtmlAttr($bylinka->photo_url) /* line 27 */;
			...
			echo LR\Filters::escapeHtmlText($bylinka->content) /* line 30 */;
			echo '</span>
                                        <h5 class="card__title card-title text-center" style="color:white">';
			echo LR\Filters::escapeHtmlText($bylinka->title) /* line 31 */;
			echo '</h5>
                                    </div>
