...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/FitCentrum/default.latte */
final class Template_de0ced8f43 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/FitCentrum/default.latte';
    ...
    <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Home:default')) /* line 7 */;
		echo '" style="text-decoration:none; color:green">Domů</a>
     <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
        ...
        -moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:green; font-size:1.5rem" class="text-center">FitCentrum</h1>
        <p class="text-center" style="font-size:0.875rem">Tady najdete vše ohledně zdraví, sportu, výživy</p></div>
            <!-- Post -->
