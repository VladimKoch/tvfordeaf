...
/** source: /data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/videos.latte */
final class Template_93060dcac5 extends Latte\Runtime\Template
{
	public const Source = '/data/web/virtuals/380391/virtual/app/Presentation/ManaCentrum/videos.latte';
    ...
    <a href="';
        ...
        <div class="mb-3 border-2" style="height:70px;margin-bottom:20px; border:1px solid grey; box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);
              ...
              -moz-box-shadow: 10px 10px 18px -10px rgba(27,27,27,0.75);"><h1 style="color:blue;font-size:1.5rem" class="text-center">Kázání</h1>
              <p class="text-center"style="font-size:0.875rem">Biblická zamyšlení o Bohu</p>
          </div>
            <!-- Post -->
...
';
		foreach ($videos as $video) /* line 19 */ {
			...
			echo LR\Filters::escapeHtmlAttr($video->video_url) /* line 25 */;
			echo '"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" allowfullscreen></iframe>
                        ...
                        <p class="text-center">';
			echo LR\Filters::escapeHtmlText($video->title) /* line 28 */;
			echo '</p>
                  </div>
                </div>
            </div>
