...
/** source: C:\xampp\htdocs\tvfordeaf\app\Presentation\FitCentrum/sekceTepny.latte */
final class Template_8225f4145c extends Latte\Runtime\Template
{
	public const Source = 'C:\\xampp\\htdocs\\tvfordeaf\\app\\Presentation\\FitCentrum/sekceTepny.latte';
...
<div class="container py-5">
    <div class="col-xl-10 mx-auto">
		...
		echo '" class="text-decoration-none fw-bold "style="color:green;">Encyklopedie rostlin</a> 
            <i class="fa-solid fa-chevron-right text-muted mx-2" style="font-size: 0.8rem;"></i>  
            <span class="text-muted fw-semibold">Tepny</span>
        </div>
      ...
      <div class="border border-black-900 rounded overflow-hidden shadow-sm" style="height:70px;margin-bottom:20px; background: white;">
        <h1 style="color:green;font-size:1.5rem" class="text-center">Tepny</h1>
            <p class="text-center" style="font-size:0.875rem">jak léčit tepny</p></div>
            <!-- Post -->
