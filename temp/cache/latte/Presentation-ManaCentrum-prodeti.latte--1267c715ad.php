...
final class Template_1267c715ad extends Latte\Runtime\Template
{
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['pribeh' => '29'], $this->params) as $ʟ_v => $ʟ_l) {
...
<div class="container py-5">
    <div class="col-xl-10 mx-auto">
		...
		echo '" class="text-decoration-none fw-bold "style="color:blue;">ManaCentrum</a> 
            <i class="fa-solid fa-chevron-right text-muted mx-2" style="font-size: 0.8rem;"></i> 
            <span class="text-muted fw-semibold">Přéběhy nejen pro děti</span>
        </div>
      ...
      <div class="border border-black-900 rounded overflow-hidden shadow-sm" style="height:70px;margin-bottom:20px; background: white;">
        <h1 style="color:blue;font-size:1.5rem" class="text-center">Přéběhy nejen pro děti</h1>
            <p class="text-center" style="font-size:0.875rem">Příběhy o Bohu nejen pro děti ale i dospělé</p></div>
        <!-- Post -->
        <div class="row g-4 py-4 row-cols-2 row-cols-md-2 row-cols-lg-4">

';
		foreach ($pribehy as $pribeh) /* line 29 */ {
			echo '            <div class="col">

                <div class="video-card">
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/';
			echo LR\Filters::escapeHtmlAttr($pribeh->video_url) /* line 33 */;
			echo '"
			...
			echo LR\Filters::escapeHtmlAttr($pribeh->title) /* line 40 */;
			echo '">';
			echo LR\Filters::escapeHtmlText($pribeh->title) /* line 40 */;
			echo '</p>
                    </div>
                </div>
