...
final class Template_ee060777fa extends Latte\Runtime\Template
{
 ...
 <div class="container px-4 py-5" style="margin-top: 50px; margin-bottom: 100px;">
    <a href="';
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ManaCentrum:biblestudium')) /* line 5 */;
...
';
		if ($fotovers) /* line 12 */ {
			...
			echo LR\Filters::escapeHtmlText(($this->filters->date)($fotovers->display_date, 'j. n. Y')) /* line 14 */;
			echo '</h4>
                <img src="';
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 15 */;
			echo '/images/verses/';
			echo LR\Filters::escapeHtmlAttr($fotovers->image_path) /* line 15 */;
