<?php
// source: /data/web/virtuals/380391/virtual/config/common.neon
// source: /data/web/virtuals/380391/virtual/config/services.neon
// source: array
...
class Container_5508e962a4 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presenters\BasePresenter' => [
			2 => ['application.2', 'application.3', 'application.4', 'application.5', 'application.9'],
		],
		'App\Presentation\Start\StartPresenter' => [2 => ['application.2']],
		'App\Presentation\Home\HomePresenter' => [2 => ['application.3']],
		'App\Presentation\Tip\TipPresenter' => [2 => ['application.4']],
		...
		'App\Presentation\Error\Error5xx\Error5xxPresenter' => [2 => ['application.7']],
		'App\Presentation\Post\PostPresenter' => [2 => ['application.8']],
		'App\Presentation\ManaCentrum\ManaCentrumPresenter' => [2 => ['application.9']],
	...
	public function createServiceApplication__1(): App\Presentation\Cookie\CookiePresenter
	{
		$service = new App\Presentation\Cookie\CookiePresenter;
	...
	public function createServiceApplication__2(): App\Presentation\Start\StartPresenter
	{
	...
	public function createServiceApplication__4(): App\Presentation\Tip\TipPresenter
	{
	...
	public function createServiceApplication__7(): App\Presentation\Error\Error5xx\Error5xxPresenter
	{
		return new App\Presentation\Error\Error5xx\Error5xxPresenter($this->getService('tracy.logger'));
	}


	public function createServiceApplication__8(): App\Presentation\Post\PostPresenter
	{
	...
	public function createServiceApplication__9(): App\Presentation\ManaCentrum\ManaCentrumPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/data/web/virtuals/380391/virtual/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/data/web/virtuals/380391/virtual/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/data/web/virtuals/380391/virtual/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_5508e962a4 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/data/web/virtuals/380391/virtual/temp/cache/latte');
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'appDir' => '/data/web/virtuals/380391/virtual/app',
			'wwwDir' => '/data/web/virtuals/380391/virtual/www',
			'vendorDir' => '/data/web/virtuals/380391/virtual/vendor',
			'rootDir' => '/data/web/virtuals/380391/virtual',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/data/web/virtuals/380391/virtual/temp',
		];
	}
}
