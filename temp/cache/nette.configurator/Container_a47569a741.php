<?php
// source: C:\xampp\htdocs\web/config/common.neon
// source: C:\xampp\htdocs\web/config/services.neon
// source: array
...
class Container_a47569a741 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Model\CalculatorManager' => [['06']],
		'Tomaj\NetteApi\Handlers\BaseHandler' => [['07']],
		'Tomaj\NetteApi\Handlers\ApiHandlerInterface' => [['07']],
		'App\MyApi\v1\Handlers\UsersListingHandler' => [['07']],
		'Tomaj\NetteApi\Link\ApiLink' => [['08']],
		'Tomaj\NetteApi\Misc\IpDetectorInterface' => [['09']],
		'Tomaj\NetteApi\Misc\IpDetector' => [['09']],
		'App\MyApi\v1\Forms\ImgForm' => [['010']],
		'App\Model\ImageUploadFormFactory' => [['011']],
		'App\Model\MailerManager' => [['012']],
		...
		'App\Presentation\Calculator\CalculatorPresenter' => [2 => ['application.3']],
		'App\Presentation\Edit\EditPresenter' => [2 => ['application.4']],
		...
		'App\Presentation\ImgApi\ImgApiPresenter' => [2 => ['application.8']],
		'App\Presentation\Mailer\MailerPresenter' => [2 => ['application.9']],
		'App\Presentation\Post\PostPresenter' => [2 => ['application.10']],
		'App\Presentation\RecoveryGroup\RecoveryGroupPresenter' => [2 => ['application.11']],
		'App\Presentation\Sign\SignPresenter' => [2 => ['application.12']],
		'App\Presentation\Table\TablePresenter' => [2 => ['application.13']],
		'App\Presentation\Tomaj\TomajPresenter' => [2 => ['application.14']],
	...
	public function createService06(): App\Model\CalculatorManager
	{
		return new App\Model\CalculatorManager;
	}


	public function createService07(): App\MyApi\v1\Handlers\UsersListingHandler
	{
		return new App\MyApi\v1\Handlers\UsersListingHandler($this->getService('013'));
	}


	public function createService08(): Tomaj\NetteApi\Link\ApiLink
	{
		return new Tomaj\NetteApi\Link\ApiLink($this->getService('application.linkGenerator'));
	}


	public function createService09(): Tomaj\NetteApi\Misc\IpDetector
	{
		return new Tomaj\NetteApi\Misc\IpDetector;
	}


	public function createService010(): App\MyApi\v1\Forms\ImgForm
	{
		return new App\MyApi\v1\Forms\ImgForm;
	}


	public function createService011(): App\Model\ImageUploadFormFactory
	{
		return new App\Model\ImageUploadFormFactory;
	}


	public function createService012(): App\Model\MailerManager
	{
		return new App\Model\MailerManager($this->getService('mail.mailer'));
	}
	...
	public function createServiceApplication__10(): App\Presentation\Post\PostPresenter
	{
	...
	public function createServiceApplication__11(): App\Presentation\RecoveryGroup\RecoveryGroupPresenter
	{
		$service = new App\Presentation\RecoveryGroup\RecoveryGroupPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__12(): App\Presentation\Sign\SignPresenter
	{
	...
	public function createServiceApplication__13(): App\Presentation\Table\TablePresenter
	{
	...
	public function createServiceApplication__14(): App\Presentation\Tomaj\TomajPresenter
	{
		$service = new App\Presentation\Tomaj\TomajPresenter($this->getService('07'), $this->getService('010'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__3(): App\Presentation\Calculator\CalculatorPresenter
	{
		$service = new App\Presentation\Calculator\CalculatorPresenter($this->getService('06'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\Presentation\Edit\EditPresenter
	{
		$service = new App\Presentation\Edit\EditPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		$service = new App\Presentation\Home\HomePresenter($this->getService('02'), $this->getService('http.request'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__8(): App\Presentation\ImgApi\ImgApiPresenter
	{
		$service = new App\Presentation\ImgApi\ImgApiPresenter($this->getService('011'), $this);
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__9(): App\Presentation\Mailer\MailerPresenter
	{
		$service = new App\Presentation\Mailer\MailerPresenter($this->getService('012'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\web/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\web/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\web/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=web', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_a47569a741 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\web/temp/cache/latte');
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'appDir' => 'C:\xampp\htdocs\web\app',
			'wwwDir' => 'C:\xampp\htdocs\web\www',
			'vendorDir' => 'C:\xampp\htdocs\web\vendor',
			'rootDir' => 'C:\xampp\htdocs\web',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\web/temp',
		];
	}
}
