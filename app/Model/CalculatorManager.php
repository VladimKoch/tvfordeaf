...
class CalculatorManager
{
     ...
     * @return array asociativní pole konstant pro operace a jejich slovní pojemování
     */
     ...
     /**
      * Zavoláme zadanou operaci a vrátí její výsledek
      * @param int $operation zadaná operace
      * @param int $x  první číslo pro operaci
      * @param int $y druhé číslo po operaci
      * @return int|null výsledek operace nebo null, pokud zadaná operae neexistuje
      */
    ...
    public function substrac(int $x, int $y){
        return $x - $y;
    }
